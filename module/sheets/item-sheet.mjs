 ...
 * @extends {ItemSheet}
 */
export class HeroSystemItemSheet extends ItemSheet {
  /** @override */
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ['hero-system', 'sheet', 'item'],
      width: 520,
      height: 480,
      tabs: [
        {
  ...
  /** @override */
  get template() {
    const path = 'systems/hero-system/templates/item';
  ...
  async getData() {
    ...
    context.skilllist = this.actor.system.skilllist;

    context.frameworklist = this.actor.system.frameworklist;
